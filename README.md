...
![My Favorite Places Map](img/My_Favorite_Places_Map.png)
...
1. [Google My Maps](https://www.google.com/maps), for generating the route lines, and exporting the geometries in `KML` format.
